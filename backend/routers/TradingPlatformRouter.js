...
class TradingPlatformRouter {
    ...
    router() {
        ...
        router.post('/add/:userID', (req, res) => {
            console.log('adding?')
            this.tradingPlatformService.addPropertyTradePost(req.body.address, req.body.catname, req.body.asking_price, req.body.area, req.body.special_note, req.body.images, req.params.userID) //req.session.passport.user.id add in?
